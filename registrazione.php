        ...
        if (!$conn) {
            ...
            if ($exists && pg_num_rows($exists) > 0) {
                ...
                $res = @pg_execute($conn, "ins_user", [
                    $nome, $cognome, $telefono, $email, $pwd_hash, $sec_q, $sec_a_hash
                ]);
...
<head>
    ...
    <style>
        /* helper per posizionare l'icona occhio all'interno del field */
        ...
        <form id="registerForm" action="registrazione.php" method="POST" class="auth-form">
            ...
            <div class="form-group has-eye">
                ...
                <div class="input-with-toggle">
                    ...
                    <i class="fas fa-eye toggle-password" id="togglePassword" role="button" tabindex="0" aria-label="Mostra o nascondi password"></i>
                </div>

                <div class="strength-container">
                    <div id="strength-bar" style="height:8px; width:0%; border-radius:4px; transition: width .28s ease, background-color .28s ease;"></div>
                </div>
            ...
            <!-- Ripeti Password (con icona per mostrare/nascondere) -->
                <div class="form-group has-eye">
                    ...
                    <div class="input-with-toggle">
                        ...
                        <i class="fas fa-eye toggle-password" id="togglePassword2" role="button" tabindex="0" aria-label="Mostra o nascondi password di conferma"></i>
                    </div>
                </div>
