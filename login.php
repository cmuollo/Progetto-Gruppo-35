    ...
    <div class="auth-card login-box">
        ...
        <form id="loginForm" action="login.php" method="POST" class="auth-form" novalidate>
            ...
            <div class="form-group" style="position: relative;">
                ...
                <i class="fas fa-eye" id="togglePassword" role="button" tabindex="0" aria-label="Mostra o nascondi password" style="position: absolute; right: 15px; top: 42px; cursor: pointer; color: #888; z-index:2;"></i>
            </div>
