    ...
    (function(){
        ...
        if (form && dateInput && orarioSelect) {
            ...
            form.addEventListener('submit', async function (e) {
                // Se stiamo già inviando (anti doppio click)
                if (bookingSubmitting) return;

                // BLOCCA SUBITO l'invio: altrimenti il form parte prima che finisca la fetch
                e.preventDefault();

                // Validazione HTML5 (mostra i messaggi del browser)
                ...
                try {
                    // 1) Check duplicati utente (stesso slot / stesso giorno)
                    ...
                    // 2) Check disponibilità (race condition)
                    ...
                    // Se falliscono le fetch, lasciamo decidere al server (non blocchiamo)
                }

                // OK: ora inviamo davvero il form
